...
/*
 * Size before adding elements: 0 Unordered Set Elements [Red, Blue, Yellow,
 * Orange, Green] Black is added successfully. Set elements after adding black
 * element [Red, Blue, Yellow, Black, Orange, Green] Set elements after adding
 * elements from given collection [Red, Brown, White, Blue, Yellow, Black,
 * Orange, Green]
 */